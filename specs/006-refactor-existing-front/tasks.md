...
- [ ] T011 [P] Integration test for cross-feature state management in frontend/tests/integration/test_cross_feature_state.test.ts
...
- [ ] T055 [P] Move adapters/workspace-dto-adapter.ts to frontend/src/shared/services/ (if used by 3+ features)
