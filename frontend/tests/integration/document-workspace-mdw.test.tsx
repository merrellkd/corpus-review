...
vi.mock("@/features/workspace/ui/stores/workspace-store", () => ({
...
describe("DocumentWorkspace + MDW Domain Integration", () => {
  ...
  it("should render DocumentWorkspace with integrated MDW functionality", async () => {
    ...
    expect(
      screen.getByTestId(
        "document-caddy-doc_123e4567-e89b-12d3-a456-426614174001"
      )
    ).toBeInTheDocument();
  ...
  it("should handle document activation through UI interaction", async () => {
    ...
    const documentCaddy = screen.getByTestId(
      "document-caddy-doc_123e4567-e89b-12d3-a456-426614174001"
    );
  ...
  it("should handle workspace dimension updates from UI resize", async () => {
    ...
    fireEvent.resize(window, {
      target: { innerWidth: 1400, innerHeight: 900 },
    });
  ...
  it("should integrate document removal operations", async () => {
    ...
    const closeButton = screen.getByTestId(
      "document-close-doc_123e4567-e89b-12d3-a456-426614174001"
    );
  ...
  it("should integrate title editing functionality", async () => {
    ...
    // Find document title
    const documentTitle = screen.getByTestId(
      "document-title-doc_123e4567-e89b-12d3-a456-426614174001"
    );
